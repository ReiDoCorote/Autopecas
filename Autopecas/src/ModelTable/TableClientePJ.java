...
public class TableClientePJ extends AbstractTableModel{
    
    private List<Cliente> dados = new ArrayList<>();
    private String[] colunas = {"ID:","Nome/RzSocial","Endereço","Cidade","CNPJ","Limite de Crédito","CEP","Telefone","Celular","Email","Bairro"};
    ...
    public Object getValueAt(int linha, int coluna) {
        switch(coluna){
            ...
            case 4:
                return dados.get(linha).getCnpjCliente();
            case 5:
    ...
    public void setValueAt(Object valor, int linha, int coluna) {
        switch(coluna){
            ...
            case 3:
                ...
                break;
            case 4:
                dados.get(linha).setCnpjCliente((String) valor);
                break;
            case 5:
